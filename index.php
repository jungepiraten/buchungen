...
if ($auth["grant"] && isset($_POST["createUser"])) {
	if (empty($_POST["username"])) {
		...
		loginCreateUser(stripslashes($_POST["username"]), (empty($_POST["accountPrefixes"]) ? array() : explode(",", $_POST["accountPrefixes"])), isset($_POST["grant"]), isset($_POST["database"]), isset($_POST["belege"]), isset($_POST["verifyTransaction"]), isset($_POST["simpleTransactions"]));
	}
